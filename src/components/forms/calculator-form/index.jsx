...
const CalculatorForm = (props) => {
  ...
  const jsonLd = useMemo(() => {
    const currentPrice =
      !isNaN(price) && price > 0 ? price : getDefaultPrice(product);

    return {
      "@context": "https://schema.org/",
      "@type": "Product",
      name: tProducts(`${product}.name`),
      description: tProducts(`${product}.description`),
      image: [
        `https://res.cloudinary.com/dllc7tavb/image/upload/c_limit,w_640/f_auto/q_70/v1//assets/products/${product}`,
      ],
      material: "Paper",
      color: "Multicolor",
      ...
      offers: {
        ...
        acceptedPaymentMethod: [
          ...
          "http://purl.org/goodrelations/v1#CardPayment",
        ],
          ...
          <div>
            <FormProvider {...methods}>
              <form>
                ...
                {!isNaN(price) || getDefaultPrice(product) > 0 ? (
                  <div>
                    <h3>
                      {tCalculator("price")}
                      <>
                    ...
                    <span>
                      <strong
                        content={
                          !isNaN(price) ? price : getDefaultPrice(product)
                        }
                      >
                        {!isNaN(price) && price !== 0
                          ? formatter.format(price)
                          : formatter.format(getDefaultPrice(product))}
                      </strong>
                      <strong>₴</strong>
                    </span>
                  </div>
                  ...
                  <>
                    {price && isNaN(price) && (
                      <Error>{tCalculator(`ERRORS.${price}`)}</Error>
                    )}
                  </>
                )}
                <Purchage>
